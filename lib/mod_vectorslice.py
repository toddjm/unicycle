...
class new():
    ...
    def __init__(self, dbh=None, left_table=None, table=None,
                 where="1=1", symbol=None, verbose=False):
        """generic"""
        self.dbh = dbh
    ...
    def print_table(self, count=None, offset=0):
        """generic"""
